...
/* @var $searchModel backend\models\FacilitiesStatesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Статусы объектов | '.Yii::$app->name;
$this->params['breadcrumbs'][] = 'Статусы объектов';

$this->params['content-block'] = 'Статусы объектов';
$this->params['content-additional'] = 'В справочнике содержатся статусы строительных объектов, например: переговоры, работы завершены.';
?>
<div class="facilities-states-list">
    <p>
