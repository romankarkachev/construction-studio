...
<div class="text-center">
    <h1><i class="pe pe-7s-paint text-primary"></i></h1>
</div>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="hpanel">
            <div class="panel-body">
                ...
                <?= $form->field($model, 'login', ['inputOptions' => ['autofocus' => 'autofocus', 'class' => 'form-control', 'tabindex' => '1', 'placeholder' => 'example@gmail.com']]) ?>
...
<div class="row">
    <div class="col-md-12 text-center">
        <strong>СТРОЙАТЕЛЬЕ</strong> - учетная система для строителей<br/> <?= date('Y') ?> Роман Каркачев
    </div>
</div>
