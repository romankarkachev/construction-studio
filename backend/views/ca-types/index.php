...
/* @var $searchModel backend\models\CATypesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Типы контрагентов | '.Yii::$app->name;
$this->params['breadcrumbs'][] = 'Типы контрагентов';

$this->params['content-block'] = 'Типы контрагентов';
$this->params['content-additional'] = 'В справочнике содержатся различные типы контрагентов, например: посредник, заказчик.';
?>
<div class="ca-types-list">
    <p>
